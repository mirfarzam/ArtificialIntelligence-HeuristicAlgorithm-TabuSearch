...
uniquelocal_minimum = list(dict.fromkeys(local_minimum))

print(f'there are {len(local_minimum)} unique local minimum \nthe best local optimum is {min(local_minimum)} \nthe worst local optimum is {max(local_minimum)}')
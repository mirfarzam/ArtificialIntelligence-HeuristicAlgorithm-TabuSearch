...
optimum_result = len(filter(lambda x: x == '3473', final_solution))

print(f'number of optimum solution found is {optimum_result}, so in {numberOfTests} iteration we faced {(optimum_result/numberOfTests)} coverage')

...
for i in range(0, numberOfTests):
    ...
    print('{i}best found solution is {} and found in interation {}, number of solutions before coverage : {}'.format(solution, coverage, number_of_solution_before_coverage))
    time.sleep( 1 )
